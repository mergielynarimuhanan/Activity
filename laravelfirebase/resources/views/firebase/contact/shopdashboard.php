...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="shopdashboard.php">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="shopdashboard.php">
   ...
   <!--  <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="login.html">Motor Parts</a>
                <a class="collapse-item" href="register.html">Car Parts</a>
                <a class="collapse-item" href="forgot-password.html">Bike Parts</a>
    ...
    <!-- Nav Item - Charts -->
    <li class="nav-item">
        <a class="nav-link" href="shopchart.php">
    ...
    <!-- Nav Item - Tables -->
    <li class="nav-item">
        <a class="nav-link" href="shoprecords.php">
